                ...
                <b-row class="mb-1 text-center">
                    <b-col cols="12">
                        <b-input-group prepend="Email Address">
                            <b-form-input v-model="email.email_address"></b-form-input>
                        </b-input-group>
                    </b-col>
                </b-row>
                <b-row>
                    <b-col cols="12">
                        <b-input-group prepend="Email Validity" class="mb-2">
                            <b-form-input v-model="email.email_validity"></b-form-input>
                        </b-input-group>
                    </b-col>
                </b-row>
                <b-row>
                    <b-col cols="12">
                        <b-input-group prepend="Skip Source" class="mb-2">
                            <b-form-input v-model="email.email_skip_source"></b-form-input>
                        </b-input-group>
                    </b-col>
                </b-row>
            </b-row>
