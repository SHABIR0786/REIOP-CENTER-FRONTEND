<template>
  <div class="slidepopup" v-bind:class="{ show: isShowSlidePopUp }">
    <div class="innerslidepopup">
      ...
      >
      <span v-if="!isShowSlidePopUp && isExporting" class="filter-and-export">
        <b-spinner small></b-spinner> Exporting
      </span>
      <span
      ...
      <div class="filter-body" v-if="isShowSlidePopUp">
        <div class="card filter-card">
          <div class="card-header p-1 d-flex justify-content-around col-12">
            ...
            <b-col cols="3" class="p-0 m-0">
              <b-button
                v-bind:class="{
                  'save-filter-btn': allFilters.Market.length > 0,
                }"
                class="float-right"
          ...
          <div class="card-body filter-card-body">
            ...
            <div v-for="(result, title) in allFilters" :key="result.userId">
              <b-card-text>
                <div
                  class="card-body pb-0 pt-2 p-0 m-0"
            ...
            <div class="filter-type">
              <div v-b-toggle.set-additional-filters>
                <p class="number">3</p>
                <p class="filter-name">Set Additional Filters</p>
                <span class="float-right">
                  <b-icon icon="chevron-down" aria-hidden="true"></b-icon>
                </span>
              </div>
        ...
        <div class="card mt-2 export-card">
          ...
          <div class="card-footer">
            <b-button
              class="float-right"
              v-bind:class="{ 'save-filter-btn': export_amount != null }"
              @click="exportfile()"
