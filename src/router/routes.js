...
export const routes = [
    ...
    {name: "Users", path: "/users", component: User, title: "Users", icon: "person", isNavbar: true, meta: {requireAuth: true, roles:[1], collapse: false, adminMode: true, isURL: false}},
    ...
    {name: "Activity", path: "/activity-v2", component: activity, title: "Activity", src:"pulse.svg", icon: "upload", isNavbar: false, meta: {requireAuth: true, roles:[1,2,3],collapse: false, adminMode: false, isURL: true}},
    {name: "Activity", path: "/activity", component: activity, title: "Activity", src:"pulse.svg", icon: "upload", isNavbar: true, meta: {requireAuth: true, roles:[1,2,3],collapse: false, adminMode: false, isURL: true}},
    {name: "List", path: "/list", component: List, title: "List", icon: "list-ul", isNavbar: true, meta: {requireAuth: true, roles:[1,2,3], collapse: false, adminMode: false, isURL: false}},
    {name: "Subject", path: "/subjects", component: Subject, title: "Subjects", icon: "file-earmark-fill", isNavbar: true, meta: {requireAuth: true, roles:[1,2,3], collapse: true, adminMode: false, isURL: false}},
    {name: "Seller", path: "/sellers", component: Seller, title: "Sellers", icon: "graph-up", isNavbar: true, meta: {requireAuth: true, roles:[1,2,3], collapse: true, adminMode: false, isURL: false}},
    {name: "PhoneNumber", path: "/phones", component: PhoneNumber, title: "Phone Numbers", icon: "telephone-fill", isNavbar: true, meta: {requireAuth: true, roles:[1,2,3], collapse: true, adminMode: false, isURL: false}},
    {name: "Email", path: "/emails", component: Email, title: "Emails", icon: "envelope-fill", isNavbar: true, meta: {requireAuth: true, roles:[1,2,3], collapse: true,adminMode: false, isURL: false}},
    {name: "GoldenAddress", path: "/golden-addresses", component: GoldenAddress, title: "Golden Addresses", icon: "geo-alt-fill", isNavbar: true, meta: {requireAuth: true, roles:[1,2,3], collapse: true ,adminMode: false, isURL: false}},
    {name: "Properties", path: "/properties", component: Properties, title: "Properties", icon: "gear", isNavbar: true, meta: {requireAuth: true, roles:[1,2,3], collapse: false, adminMode: false}},
    ...
    {name: "Teams", path: "/teams", component: Team, title: "Teams", isNavbar: false, meta: {requireAuth: true, roles:[2,1]}},
